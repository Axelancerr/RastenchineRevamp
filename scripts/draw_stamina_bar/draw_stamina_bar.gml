...
#macro STAMINA_BAR_BACKGROUND_X      (GUI_X2 - STAMINA_BAR_BACKGROUND_WIDTH)
...
function draw_stamina_bar() {
	...
	draw_sprite_stretched(
		spr_gui_foreground, 0,
		STAMINA_BAR_FOREGROUND_X, 
		STAMINA_BAR_FOREGROUND_Y,
		STAMINA_BAR_FOREGROUND_WIDTH * (stamina / PLAYER_STAMINA_MAXIMUM), 
		STAMINA_BAR_FOREGROUND_HEIGHT
	)
	if (state.get_current_state() == "exhausted") {
	...
	if (global.debug_options.debug_text == true) {
		...
		draw_text_colour(
			...
			string(stamina) + "/" + string(PLAYER_STAMINA_MAXIMUM), 
